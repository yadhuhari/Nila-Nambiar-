...
class Config(object):
	...
	DATABASE_URL = os.environ.get("mongodb+srv://GODOFTHUNDER:GODOFTHUNDER@cluster0.19yqr.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("MDC_Linkzz", "")
